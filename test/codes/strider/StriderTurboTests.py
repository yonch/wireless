...
class StriderTurboTests(unittest.TestCase):
    ...
    def test_002_test_vectors_decode_no_noise(self):
        # input and output bits were prepared using CML, using Cdma2000 scenario
        #    number 5.
        messageStr = file('turbo-message-1530.dat').read()
        codewordStr = file('turbo-interleaved-1530.dat').read()
        ...
        # get encoder
        dec = rf.codes.strider.StriderTurboCode.createDecoder(1530)
    ...
    def test_003_test_vectors_decode(self):
        # input and output bits were prepared using CML, using Cdma2000 scenario
        #    number 5.
        messageStr = file('turbo-message-1530.dat').read()
        codewordStr = file('turbo-interleaved-1530.dat').read()
